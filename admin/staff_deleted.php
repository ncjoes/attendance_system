...
if (isset($array['search_button']) || //$array from index.php
    ...
    if (isset($page)) {
        ...
        $staff = searchStaff($searchQuery, true, false, $sort_type, $order);
    } else {
        $page = 1;
        $staff = getDeletedStaff();
    }
...
<div>
    <h4>USERS</h4>
    <div class="row">
        <a href="view.php?p=12" class="button disabled place-right">Deleted</a>
    ...
    <div class="row">
        ...
        if (empty($staff) and ! isset($array['search_button'])) {
            ...
            <div class="bg-grayLighter padding5">
                <form method="post" action="view.php?p=12">
            ...
            ?>
            <div id="top">
                <form action="view.php?p=12" method="post" name="form1">
                    ...
                    <div class="row">
                        <input name="activate_button" type="submit" value="Restore"/>
                    </div>
                    <div class="row ntm">
