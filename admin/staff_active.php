...
if (isset($array['search_button']) || //$array from index.php
    ...
    try {
        if (isset($array['delete_button']) && isset($array['checkbox'])) {
            ...
            $actionPerformed = true;
            $user->suspendStaff($array['checkbox']);
        }
        $success = true;
        $error_message = "";
    } catch (Exception $exc) {
    ...
    if (isset($page)) {
        ...
        $staff = searchStaff($searchQuery, false, false, $sort_type, $order);
    } else {
        $page = 1;
        $staff = getActiveStaff();
    }
...
<div>
    ...
    <div class="row">
        ...
        <a href="view.php?p=11" class="button bg-blue bg-hover-dark fg-white place-right">Suspended</a>
        <a href="view.php?p=1" class="button disabled place-right">Active</a>
    </div>
    <div class="row">
        <?php
        if (empty($staff) and ! isset($array['search_button'])) {
            echo '<p>No active staff</p>';
        } else {
            ?>
            <div class="bg-grayLighter padding5">
                <form method="post" action="view.php?p=1">
            ...
            ?>
            <div id="top">
                <form action="view.php?p=1" method="post" name="form1">
                    ...
                    <div class="row">
                        ...
                        <input name="suspend_button" type="submit" value="Suspend"/>
                    </div>
                    <br/>
                    <div class="row ntm">
