                    ...
                    <table class="table hovered bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">Approved Start Time</th>
                                <th class="text-left">Approved Duration</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            echo '<tr><td colspan="8"><a href="#top">back to top</a></td></tr>';
                                ...
                                <tr>                            
                                    ...
                                    <td class="text-left"><?= $requests[$index]['date_approved'] ?></td>
                                    <td class="text-left"><?= $requests[$index]['approved_start_time'] ?></td>
                                    <td class="text-left"><?= $requests[$index]['approved_duration'] ?></td>
                                </tr>
                                <?php
                            }
                            echo '<tr><td colspan="8"><a href="#top">back to top</a></td></tr>';
